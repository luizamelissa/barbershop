...
import { LayoutDashboard, CalendarDays, Users, Scissors, Clock, DollarSign, Star, BarChart3, LogOut } from "lucide-react";
...
export default function AdminSidebar() {
  ...
  const menuItems = [
    ...
    { path: "/barber/reviews", name: "Avaliações", icon: <Star size={20} /> },
